...
MonitorConfig monitors_config[] = {
	...
	{"HDMI-0~1", -40},  // BUG:(ignored DPI=220): = 20 is eqv to 10pt (DPI=110)
	{"HDMI-0~2", -40},
};
...
float alpha = 0.8;
/* Pywal integration */
#include "/home/abu/.cache/wal/colors-wal-st.h"
...
static Key key[] = {
	...
	{ XK_ISO_Left_Tab, ShiftMask|ControlMask, "\033[{", 0,   0},
	...
	{ XK_Tab,          ControlMask|ShiftMask,          "\033[{",   0,  0},
